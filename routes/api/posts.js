...
//   "/:id",
//   [auth, upload.fields([
//     { name: 'radiopanoramicbefore', maxCount: 1 },
//     { name: 'radiopanoramicafter', maxCount: 1 },
//     { name: 'conebeamafter', maxCount: 1 },
//     { name: 'conebeambefore', maxCount: 1 },
//     { name: 'endobuccaleafter', maxCount: 1 },
//     { name: 'endobuccalebefore', maxCount: 1 },
//     { name: 'teleradioprofilafter', maxCount: 1 },
//     { name: 'teleradioprofilbefore', maxCount: 1 },
//     { name: 'vuefaceafter', maxCount: 1 },
//     { name: 'vuefacebefore', maxCount: 1 },
//     { name: 'vueprofilafter', maxCount: 1 },
//     { name: 'vueprofilbefore', maxCount: 1 },
//   ])],
//   async (req, res) => {
//     const errors = validationResult(req);
//     //   if there are errors
...
//   // Loop through the image fields and update the corresponding URLs
//   if (!post.postInfo.postImages) {
//     post.postInfo.postImages = {};
//   }

//   // Handle uploaded images and update postImages attributes
//   const updatedPostImages = { ...post.postInfo.postImages }; // Preserve existing image URLs
//   console.log(req);
//   // Loop through the image fields and update the corresponding URLs
...
//     if (file) {
//       // Generate a unique filename or use the original filename as needed
...
//       // Update the URL for the current image attribute
//       updatedPostImages[fieldName] = imagePath;
//     }
//   });
