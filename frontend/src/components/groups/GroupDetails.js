...
const GroupDetails = ({postInfo, auth, user, deleteGroup, _id, getGroup, match}) => {
      ...
      <div>
        {!auth.loading && user === auth.user._id && (
          <div>
            ...
            >
              <Box sx={style}>
                <EditGroup _id={_id} postInfo={postInfo}  getPost={getGroup} match={match} handleCloseEditPost={handleCloseEditPost}/>
