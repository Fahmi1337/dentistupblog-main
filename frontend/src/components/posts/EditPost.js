      ...
      <form className="form my-1">
        ...
        <div className="form-group">
          <input
            ...
            value="Buccal"
            name="respirationType"
            checked={respirationType === "Buccal"}
            onChange={onChange}
            className="form-control"
          />
          Buccal
        ...
        <div className="form-group">
          <input
            ...
            name="mastication"
            value="Unilatéral"
            checked={mastication === "Unilatéral"}
            onChange={onChange}
            className="form-control"
          />
          Unilatéral
        ...
        <div className="form-group">
          <input
            ...
            name="mastication"
            value="Bi-latéral"
            checked={mastication === "Bi-latéral"}
            onChange={onChange}
            className="form-control"
          />
          Bi-latéral
